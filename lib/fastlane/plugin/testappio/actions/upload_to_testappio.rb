      ...
      def self.available_options
        ...
        [
          FastlaneCore::ConfigItem.new(key: :api_token,
                                       env_name: "FL_UPLOAD_TO_TESTAPPIO_API_TOKEN",
                                       description: "API Token for UploadToTestappioAction",
                                       verify_block: proc do |value|
                                         UI.user_error!("No API token for UploadToTestappioAction given, pass using `api_token: 'token'`") unless value && !value.empty?
                                       end),
